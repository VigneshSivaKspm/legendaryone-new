...
const CollegeProjects = () => {
  const benefits = [
    { title: "Expert Guidance", desc: "Learn from experienced developers" },
    {
      title: "Technical Support",
      desc: "Help with implementation and debugging",
    },
    {
      title: "Best Practices",
      desc: "Industry-standard coding and architecture",
    },
    {
      title: "Innovation Focus",
      desc: "Build impressive, cutting-edge projects",
    },
    { title: "Career Preparation", desc: "Skills that lead to great jobs" },
    {
      title: "Project Delivery",
      desc: "Ensure successful completion and grades",
    },
  ];
      ...
      <section className="relative pt-28 pb-20 bg-white overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="mb-8 flex items-center gap-2 text-sm text-slate-500">
            ...
            <span>/</span>
            <span className="text-navy font-semibold">College Projects</span>
          </div>
          ...
          <div className="mb-20">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mb-8 leading-relaxed">
              Guidance and technical support for innovative student projects.
              Learn cutting-edge technologies while building projects that
              impress.
            </p>
            <Link
              to="/contact"
                ...
                {[
                  {
                    ...
                    desc: "Full-stack projects with databases and APIs",
                  },
                  {
                    num: "02",
                    title: "Mobile Apps",
                  ...
                  },
                  {
                    ...
                    desc: "Machine learning and data science projects",
                  },
                  {
                    num: "04",
                    title: "Blockchain",
                    desc: "Smart contracts and crypto projects",
                  },
                  {
                    num: "05",
                    title: "IoT Solutions",
                  ...
                  },
                  {
                    ...
                    desc: "2D/3D games and interactive experiences",
                  },
                ].map((item, i) => (
          ...
          <div className="text-center">
            <h2 className="font-display font-black text-3xl text-navy mb-4">
              Build Amazing Projects Today
            </h2>
            <p className="text-slate-600 mb-8 max-w-xl mx-auto">
              Let's create college projects that not only get great grades but
              also impress future employers.
            </p>
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 px-8 py-3.5 bg-gradient-to-r from-azure to-llime text-white font-bold rounded-full shadow-azure-md hover:shadow-azure-lg hover:-translate-y-0.5 transition-all duration-200"
